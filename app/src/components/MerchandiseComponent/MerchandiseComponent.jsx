  ...
  if(merchandise.length>0){
    ...
    <div className="merch-component">
      ...
      <div className="merch-component-header">
        <div className="merch-component-header-img">
          <img src={assets.bullet3} alt="image" />
        </div>
        <div className="merch-component-header-top">
          <h2>THE AFRICAN BABA</h2>
        </div>
        <div className="merch-component-header-mid">
      ...
      <div className="merch-footer">
       <Link to={'/merchandise'}><button>SHOP NOW</button></Link>
      </div>
    </div>
    </>
  )
